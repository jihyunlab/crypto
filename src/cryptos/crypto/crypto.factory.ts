...
export const create = (
  ...
  switch (crypto) {
    case CRYPTO.AES_128_CBC:
      return new Crypto('aes-128-cbc', password, salt, 128 / 8, iv);
    ...
    case CRYPTO.AES_128_CFB:
      return new Crypto('aes-128-cfb', password, salt, 128 / 8, iv);
    case CRYPTO.AES_192_CFB:
      return new Crypto('aes-192-cfb', password, salt, 192 / 8, iv);
    case CRYPTO.AES_256_CFB:
      return new Crypto('aes-256-cfb', password, salt, 256 / 8, iv);
    case CRYPTO.AES_128_CFB1:
      return new Crypto('aes-128-cfb1', password, salt, 128 / 8, iv);
    case CRYPTO.AES_192_CFB1:
      return new Crypto('aes-192-cfb1', password, salt, 192 / 8, iv);
    case CRYPTO.AES_256_CFB1:
      return new Crypto('aes-256-cfb1', password, salt, 256 / 8, iv);
    case CRYPTO.AES_128_CFB8:
      return new Crypto('aes-128-cfb8', password, salt, 128 / 8, iv);
    case CRYPTO.AES_192_CFB8:
      return new Crypto('aes-192-cfb8', password, salt, 192 / 8, iv);
    case CRYPTO.AES_256_CFB8:
      return new Crypto('aes-256-cfb8', password, salt, 256 / 8, iv);
    case CRYPTO.AES_128_CTR:
      return new Crypto('aes-128-ctr', password, salt, 128 / 8, iv);
    case CRYPTO.AES_192_CTR:
      return new Crypto('aes-192-ctr', password, salt, 192 / 8, iv);
    case CRYPTO.AES_256_CTR:
      return new Crypto('aes-256-ctr', password, salt, 256 / 8, iv);
    case CRYPTO.AES_128_OFB:
      return new Crypto('aes-128-ofb', password, salt, 128 / 8, iv);
